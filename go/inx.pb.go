...
func (LedgerUpdate_Marker_MarkerType) EnumDescriptor() ([]byte, []int) {
	return file_inx_proto_rawDescGZIP(), []int{26, 0, 0}
}
...
func (*LedgerUpdate_Marker) Descriptor() ([]byte, []int) {
	return file_inx_proto_rawDescGZIP(), []int{26, 0}
}
...
var file_inx_proto_rawDesc = []byte{
	...
	0x69, 0x70, 0x73, 0x22, 0x1f, 0x0a, 0x0d, 0x54, 0x72, 0x61, 0x6e, 0x73, 0x61, 0x63, 0x74, 0x69,
	...
	0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x32, 0xc0, 0x07, 0x0a, 0x03, 0x49, 0x4e, 0x58, 0x12, 0x30,
	...
	0x69, 0x70, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x39, 0x0a, 0x12, 0x52,
...
var file_inx_proto_msgTypes = make([]protoimpl.MessageInfo, 33)
var file_inx_proto_goTypes = []interface{}{
	...
	(*TransactionId)(nil),                       // 24: inx.TransactionId
	(*OutputId)(nil),                            // 25: inx.OutputId
	(*OutputResponse)(nil),                      // 26: inx.OutputResponse
	(*UnspentOutput)(nil),                       // 27: inx.UnspentOutput
	(*RawOutput)(nil),                           // 28: inx.RawOutput
	(*LedgerOutput)(nil),                        // 29: inx.LedgerOutput
	(*LedgerSpent)(nil),                         // 30: inx.LedgerSpent
	(*LedgerUpdate)(nil),                        // 31: inx.LedgerUpdate
	(*APIRouteRequest)(nil),                     // 32: inx.APIRouteRequest
	(*APIRequest)(nil),                          // 33: inx.APIRequest
	(*APIResponse)(nil),                         // 34: inx.APIResponse
	(*LedgerUpdate_Marker)(nil),                 // 35: inx.LedgerUpdate.Marker
	nil,                                         // 36: inx.APIRequest.HeadersEntry
	nil,                                         // 37: inx.APIResponse.HeadersEntry
}
var file_inx_proto_depIdxs = []int32{
	...
	29, // 22: inx.OutputResponse.output:type_name -> inx.LedgerOutput
	30, // 23: inx.OutputResponse.spent:type_name -> inx.LedgerSpent
	12, // 24: inx.UnspentOutput.latest_commitment_id:type_name -> inx.CommitmentId
	29, // 25: inx.UnspentOutput.output:type_name -> inx.LedgerOutput
	25, // 26: inx.LedgerOutput.output_id:type_name -> inx.OutputId
	...
	28, // 29: inx.LedgerOutput.output:type_name -> inx.RawOutput
	29, // 30: inx.LedgerSpent.output:type_name -> inx.LedgerOutput
	12, // 31: inx.LedgerSpent.commitment_id_spent:type_name -> inx.CommitmentId
	24, // 32: inx.LedgerSpent.transaction_id_spent:type_name -> inx.TransactionId
	35, // 33: inx.LedgerUpdate.batch_marker:type_name -> inx.LedgerUpdate.Marker
	30, // 34: inx.LedgerUpdate.consumed:type_name -> inx.LedgerSpent
	29, // 35: inx.LedgerUpdate.created:type_name -> inx.LedgerOutput
	36, // 36: inx.APIRequest.headers:type_name -> inx.APIRequest.HeadersEntry
	37, // 37: inx.APIResponse.headers:type_name -> inx.APIResponse.HeadersEntry
	...
	25, // 52: inx.INX.ReadOutput:input_type -> inx.OutputId
	32, // 53: inx.INX.RegisterAPIRoute:input_type -> inx.APIRouteRequest
	32, // 54: inx.INX.UnregisterAPIRoute:input_type -> inx.APIRouteRequest
	33, // 55: inx.INX.PerformAPIRequest:input_type -> inx.APIRequest
	...
	23, // 66: inx.INX.RequestTips:output_type -> inx.TipsResponse
	27, // 67: inx.INX.ReadUnspentOutputs:output_type -> inx.UnspentOutput
	31, // 68: inx.INX.ListenToLedgerUpdates:output_type -> inx.LedgerUpdate
	26, // 69: inx.INX.ReadOutput:output_type -> inx.OutputResponse
	5,  // 70: inx.INX.RegisterAPIRoute:output_type -> inx.NoParams
	5,  // 71: inx.INX.UnregisterAPIRoute:output_type -> inx.NoParams
	34, // 72: inx.INX.PerformAPIRequest:output_type -> inx.APIResponse
...
func file_inx_proto_init() {
	...
	file_inx_proto_msgTypes[21].OneofWrappers = []interface{}{
