...
var file_inx_proto_rawDesc = []byte{
	...
	0x01, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x04, 0x64, 0x61, 0x74, 0x61, 0x22, 0x97, 0x02, 0x0a, 0x0c,
	...
	,
	...
	0x64, 0x5f, 0x73, 0x70, 0x65, 0x6e, 0x74, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x11, 0x2e,
	...
	0x6f, 0x6e, 0x5f, 0x69, 0x64, 0x5f, 0x73, 0x70, 0x65, 0x6e, 0x74, 0x18, 0x03, 0x20, 0x01, 0x28,
	...
	0x74, 0x5f, 0x73, 0x70, 0x65, 0x6e, 0x74, 0x18, 0x04, 0x20, 0x01, 0x28, 0x04, 0x52, 0x09, 0x73,
	...
	0x65, 0x3a, 0x02, 0x38, 0x01, 0x32, 0xbc, 0x07, 0x0a, 0x03, 0x49, 0x4e, 0x58, 0x12, 0x30, 0x0a,
...
var file_inx_proto_depIdxs = []int32{
	...
	12, // 26: inx.LedgerOutput.commitment_id_included:type_name -> inx.CommitmentId
	31, // 27: inx.LedgerOutput.output:type_name -> inx.RawOutput
	32, // 28: inx.LedgerSpent.output:type_name -> inx.LedgerOutput
	12, // 29: inx.LedgerSpent.commitment_id_spent:type_name -> inx.CommitmentId
	27, // 30: inx.LedgerSpent.transaction_id_spent:type_name -> inx.TransactionId
	38, // 31: inx.LedgerUpdate.batch_marker:type_name -> inx.LedgerUpdate.Marker
	33, // 32: inx.LedgerUpdate.consumed:type_name -> inx.LedgerSpent
	32, // 33: inx.LedgerUpdate.created:type_name -> inx.LedgerOutput
	39, // 34: inx.APIRequest.headers:type_name -> inx.APIRequest.HeadersEntry
	40, // 35: inx.APIResponse.headers:type_name -> inx.APIResponse.HeadersEntry
	4,  // 36: inx.LedgerUpdate.Marker.marker_type:type_name -> inx.LedgerUpdate.Marker.MarkerType
	5,  // 37: inx.INX.ReadNodeStatus:input_type -> inx.NoParams
	9,  // 38: inx.INX.ListenToNodeStatus:input_type -> inx.NodeStatusRequest
	5,  // 39: inx.INX.ReadNodeConfiguration:input_type -> inx.NoParams
	13, // 40: inx.INX.ReadCommitment:input_type -> inx.CommitmentRequest
	5,  // 41: inx.INX.ListenToBlocks:input_type -> inx.NoParams
	5,  // 42: inx.INX.ListenToAcceptedBlocks:input_type -> inx.NoParams
	5,  // 43: inx.INX.ListenToConfirmedBlocks:input_type -> inx.NoParams
	17, // 44: inx.INX.SubmitBlock:input_type -> inx.RawBlock
	18, // 45: inx.INX.ReadBlock:input_type -> inx.BlockId
	18, // 46: inx.INX.ReadBlockMetadata:input_type -> inx.BlockId
	22, // 47: inx.INX.SubmitPayload:input_type -> inx.RawPayload
	5,  // 48: inx.INX.ReadUnspentOutputs:input_type -> inx.NoParams
	14, // 49: inx.INX.ListenToLedgerUpdates:input_type -> inx.SlotRangeRequest
	28, // 50: inx.INX.ReadOutput:input_type -> inx.OutputId
	35, // 51: inx.INX.RegisterAPIRoute:input_type -> inx.APIRouteRequest
	35, // 52: inx.INX.UnregisterAPIRoute:input_type -> inx.APIRouteRequest
	36, // 53: inx.INX.PerformAPIRequest:input_type -> inx.APIRequest
	8,  // 54: inx.INX.ReadNodeStatus:output_type -> inx.NodeStatus
	8,  // 55: inx.INX.ListenToNodeStatus:output_type -> inx.NodeStatus
	6,  // 56: inx.INX.ReadNodeConfiguration:output_type -> inx.NodeConfiguration
	15, // 57: inx.INX.ReadCommitment:output_type -> inx.Commitment
	19, // 58: inx.INX.ListenToBlocks:output_type -> inx.Block
	21, // 59: inx.INX.ListenToAcceptedBlocks:output_type -> inx.BlockMetadata
	21, // 60: inx.INX.ListenToConfirmedBlocks:output_type -> inx.BlockMetadata
	18, // 61: inx.INX.SubmitBlock:output_type -> inx.BlockId
	17, // 62: inx.INX.ReadBlock:output_type -> inx.RawBlock
	21, // 63: inx.INX.ReadBlockMetadata:output_type -> inx.BlockMetadata
	18, // 64: inx.INX.SubmitPayload:output_type -> inx.BlockId
	30, // 65: inx.INX.ReadUnspentOutputs:output_type -> inx.UnspentOutput
	34, // 66: inx.INX.ListenToLedgerUpdates:output_type -> inx.LedgerUpdate
	29, // 67: inx.INX.ReadOutput:output_type -> inx.OutputResponse
	5,  // 68: inx.INX.RegisterAPIRoute:output_type -> inx.NoParams
	5,  // 69: inx.INX.UnregisterAPIRoute:output_type -> inx.NoParams
	37, // 70: inx.INX.PerformAPIRequest:output_type -> inx.APIResponse
